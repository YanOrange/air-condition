        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn layui-btn-danger" onclick="xadmin.open('新增','/page/addRoom',800,600)"
                            href="javascript:;">
                        <i class="layui-icon iconfont">&#xe6b9;</i>新增房间
                    </button>
            ...
            function () {
                ...
                table.render({
                    ...
                    cols: [[
                        ...
                        {field: 'name', title: '房间名', sort: true, width: 120},
...
<script type="text/html" id="barTeacher">
    <a title="编辑" onclick="xadmin.open('编辑','/room/toEditRoom?roomId={{d.id}}',800,600)" href="javascript:;">
